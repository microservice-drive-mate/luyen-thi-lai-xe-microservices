...
set_kv "config/development/identity-service/keycloak.clientSecret" "TJeHbSwgzqRbv2NDayeu7H5odjr29O1C"
...
set_kv "config/development/user-service/keycloak.clientSecret" "TJeHbSwgzqRbv2NDayeu7H5odjr29O1C"
...
set_kv "config/development-local/identity-service/keycloak.clientSecret" "TJeHbSwgzqRbv2NDayeu7H5odjr29O1C"
...
set_kv "config/development-local/user-service/keycloak.clientSecret" "TJeHbSwgzqRbv2NDayeu7H5odjr29O1C"
...
set_kv "config/development-local/docs-service/swagger.services" "identity-service:3001,user-service:3002,exam-service:3003,course-service:3004,question-service:3005,notification-service:3006,analytics-service:3007,simulation-service:3008"
