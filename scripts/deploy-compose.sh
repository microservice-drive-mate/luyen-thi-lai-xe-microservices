...
ssh "${ssh_opts[@]}" "${DEPLOY_USER}@${DEPLOY_HOST}" \
  "mkdir -p '${remote_root}' '${remote_kong_dir}' '${remote_kong_runtime_dir}' '${remote_consul_dir}' '${remote_keycloak_dir}' '${remote_logstash_dir}' '${remote_alertmanager_dir}' '${remote_prometheus_dir}' '${remote_grafana_datasource_dir}' '${remote_grafana_dashboard_provider_dir}' '${remote_grafana_dashboards_dir}'"
